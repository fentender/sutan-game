...
class CodeEditor(QPlainTextEdit):
    ...
    def highlight_line(self, line_no: int, scroll_to: bool = True,
                       color: QColor | None = None, append: bool = False) -> None:
...
class JsonEditorDialog(QDialog):
    ...
    def _load_and_highlight(self) -> None:
        """读取文件内容并检测错误位置"""
    ...
    def _update_highlights(self, scroll_to_error: bool = True) -> None:
